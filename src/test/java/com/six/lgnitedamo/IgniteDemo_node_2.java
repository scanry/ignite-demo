 ...
 */
public class IgniteDemo_node_2 {
	...
	public static void main(String[] args) {
		...
		discoverySpi.setLocalPort(8882);
		TcpDiscoveryVmIpFinder tcpDiscoveryVmIpFinder=new TcpDiscoveryVmIpFinder();
		tcpDiscoveryVmIpFinder.setShared(true);
		tcpDiscoveryVmIpFinder.setAddresses(Arrays.asList(localHost+":8881",localHost+":8882"));
		...
		executorService.execute(new ProduceRunner());
